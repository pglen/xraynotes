...

{
	...
	if(gotbmp)
		...
		pDC->BitBlt(5, 5, m_nWidth, m_nHeight, &dcMem, 0, 0, rop);
...

{
	if(pMsg->message == WM_CREATE)
		{
		P2N("CBmpButt::PreTranslateMessage::WM_CREATE\r\n");
		//SubclassWindow(m_hWnd);	
		}

	if(pMsg->message == WM_CHAR)
		{
		P2N("CBmpButt::PreTranslateMessage::WM_CHAR\r\n");
...
int CBmpButt::OnCreate(LPCREATESTRUCT lpCreateStruct) 

{
	P2N("CBmpButt::OnCreate\r\n");
...
void CBmpButt::PreSubclassWindow() 

{
	P2N("CBmpButt::PreSubclassWindow\r\n");	

	CWnd::PreSubclassWindow();
	//SubclassWindow(m_hWnd);	
}

BOOL CBmpButt::PreCreateWindow(CREATESTRUCT& cs) 
{
	P2N("CBmpButt::Pre Create\r\n");	
