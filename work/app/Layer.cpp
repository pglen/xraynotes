...
#define DYN_CAST_CALL(func, retx, typex,  arg1,arg2,arg3)				\
		if(&typex::func != &CLayer::func)					\
			retx = dynamic_cast<typex*>(this)->func(arg1, arg2, arg3);	
	
//	if (dynamic_cast<typex*>(this) != this)					\

#define CALLCASTS(func, retx, arg1,arg2,arg3)					\
	switch(gdata.kind)											\
		{														\
		case    LAYER_NONE:								\
			break;									\
													\
		case    LAYER_LINES     :           					\
			DYN_CAST_CALL(func, retx, CLayLines, arg1,arg2,arg3);	\
			break;                          					\
			                                					\
		case    LAYER_SLINE     :                       		\
			DYN_CAST_CALL(func, retx, CLaySline, arg1,arg2,arg3);	\
			break;                                      		\
                                                        		\
		case    LAYER_RECT      :                       		\
			DYN_CAST_CALL(func, retx, CLayRect, arg1,arg2,arg3);	\
			break;                                      		\
                                                        		\
		case    LAYER_ELLIPSE   :                       		\
			DYN_CAST_CALL(func, retx, CLayCirc, arg1,arg2,arg3);	\
			break;                                      		\
                                                        		\
		case    LAYER_TEXT:                       				\
			DYN_CAST_CALL(func, retx, CLayText, arg1,arg2,arg3);	\
			break;                                      		\
                                                        		\
		case    LAYER_IMAGE     :								\
			DYN_CAST_CALL(func, retx, CLayImg, arg1,arg2,arg3);	\
			break;												\
	                                                    		\
		default:			                            		\
			P2N("Invalid layer %d\r\n", gdata.kind);   			\
...

{
	...
	gl_factor = factor;
	CALLCASTS(Draw, ret, pDC, factor, 0);
	//DYN_CAST_CALL(Draw, ptr2, CLayLines);
...

{
	...
	CALLCASTS(MouseEvent, ret, event, nFlags, point);
...

{
	...
	CALLCASTS(KeyEvent, ret, event, nFlags, nChar)
...

{
	...
	CALLCASTS(Init, ret, pt, dummy1, dummy2);
...

{
	...
	int ret = 0;
	CALLCASTS(HitTest, ret, pt, dummy1, dummy2);
...

{
	...
	int ret = 0;
	CALLCASTS(Invalidate, ret, 0, 0, 0);
