...
/* =====[ CodeEd.cpp ]========================================== 
   ...
   Description:     The xraynotes project, implementation of the CodeEd.cpp                
   ...
   Revisions:                                                                
      ...
      ----  --------  -----------  ----------------------------   
      0.00  12/12/2008  Peter Glen   Initial version.                         
...
BEGIN_MESSAGE_MAP(CCodeEd, CGrayDlg)
	//{{AFX_MSG_MAP(CCodeEd)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
...

{
	...
	CString dbfile = dataroot + "db\\codes.sqlt";
 ...
 
{
	...
	if(	m_id2    != m_id		||
		...
		CString dbfile = dataroot + "codes.sqlt";
		rc = sqlite3_open(dbfile, &db);
