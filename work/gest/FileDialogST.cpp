...
//////////////////////////////////////////////////////////////////////////
//
// Function name:    OFNHookProc
// Description:      <empty description>
// Return type:      UINT CALLBACK 
// Argument:          HWND hdlg
// Argument:         UINT uiMsg
...
UINT CALLBACK CFileDialogST::OFNHookProc( HWND hdlg, UINT uiMsg, WPARAM wParam, LPARAM lParam)

{
	//P2N("Called hook %s procedure win=%x\r\n", mxpad.num2msg(uiMsg), hdlg);
