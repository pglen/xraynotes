...
char    *MxPad::num2sbarcom(int cmd)
...

{
	...
	switch(cmd)
		...
		//case SB_LINELEFT:     str =   "SB_LINELEFT"; break;
		//case SB_LINERIGHT:    str =   "SB_LINERIGHT"; break;
		case SB_PAGEUP:         str =   "SB_PAGEUP"; break;
		case SB_PAGEDOWN:       str =   "SB_PAGEDOWN"; break;
		//case SB_PAGELEFT:     str =   "SB_PAGELEFT"; break;
		//case SB_PAGERIGHT:    str =   "SB_PAGERIGHT"; break;
...

{
    ...
    switch(msg)
		...
		case 280				  :	str = "WM_CARET"; break;
		case WM_MOUSEHOVER		  : str = "WM_MOUSEHOVER "; break;
		case WM_MOUSELEAVE		  :	str = "WM_MOUSELEAVE"; break;
