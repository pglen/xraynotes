...

{
	...
	P2N("Callback from calendar ctrl for %s\r\n", dstr);
	...
	rc = sqlite3_open("calendar.sqlt", &db);
...

{
	...
	if(pMsg->message == CALITEM_DBLCLICK)
		...
		P2N("Dbleclick message from calendar ctrl=%d  hour=%d day=%d hiword=%d\r\n", 
...
//DEL void CXcalDlg::InvalidateCal()
//DEL {
//DEL 
//DEL 
//DEL }
