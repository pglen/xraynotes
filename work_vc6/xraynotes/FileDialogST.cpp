...
/* =====[ FileDialogST.cpp ]========================================== 
   ...
   Description:     The xraynotes project, implementation of the FileDialogST.cpp                
...
CFileDialogST::CFileDialogST(BOOL bOpenFileDialog, LPCTSTR lpszDefExt, LPCTSTR lpszFileName, DWORD dwFlags, LPCTSTR lpszFilter, CWnd* pParentWnd)
{
	...
	// Make main application window to parent
	if (pParentWnd != NULL)
...

{
	...
	// Let the window close after user selected close
