...
// This number will show up on the plugin menu as 1.0

#define DLLVER	10	

//////////////////////////////////////////////////////////////////////////
// XrayNotes will not check the DLLs that are less than the API version it 
// needs. Current version is 10  (synonym for major.minor -> 1.0)
...
"and sleeps one millisecond before processing the next line.\r\n"
"Useful for testing the plusin's 'Stop' function";
...
//		BIT_1 set if you want the image to refresh in XrayNotes.
...

{
	...
	for(yy = 0; yy < height; yy++ )
		...
		yyy += effw;	// this way we have incremental buffer 
						// access, no expensive multiplyer is needed
