...

{
	...
	CONFCHEVRON(nw, "nw", 10, 10, &nwfo, ">>");
	CONFCHEVRON(sw, "sw", 10, rc.bottom - 100, &swfo, ">>");
	CONFCHEVRON(ne, "ne", rc.right - 40, 10, &nefo, "<<");
	CONFCHEVRON(se, "se", rc.right - 40, rc.bottom - 100, &sefo, "<<");
