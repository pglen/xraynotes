...
////////////////////////////////////////////////////////////////////////////////
// Set Transparent Treshold
//

void CxImage::SetTransTresh(int ttresh)
{
	info.trans_tresh = ttresh;
}
...
void CxImage::DrawLineX(int StartX, int StartY, int EndX, int EndY, RGBQUAD color, bool bSetAlpha)

{
	DrawLine(StartX, EndX, 	head.biHeight - StartY , head.biHeight - EndY,  color, bSetAlpha);
}
