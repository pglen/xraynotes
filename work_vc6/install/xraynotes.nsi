...
Section "-Install XrayNotes Code" SecCode
    ...
    File  /oname=XrayNotes.exe ..\xraynotes\Release\xraynotes.exe
	...
	;// Python output
	File  /r /x ".svn" /x "*.obj" /x "*.pch" /x "*.pdb" /x ".ilk" /x "*.idb" /x "*.exp" /x "*.ncb" /x "*.opt" /x "*.plg" ..\xraynotes\python
	
	;// Image processing plugins
	File  /r /x "*.svn" /x "*.obj" /x "*.pch" /x "*.pdb" /x "*.ilk" /x "*.idb" /x "*.exp" /x "*.ncb" /x "*.opt" /x "*.plg" "..\xraynotes\plugins"
