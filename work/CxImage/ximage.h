...
//@}
	...
	/// Added by PG
	void CxImage::CovertBlack();
	void DrawLineX(int StartX, int EndX, int StartY, int EndY, RGBQUAD color, bool bSetAlpha = true);
	void SetTransTresh(int ttresh);
...
/** \addtogroup Painting */ //@{
	...
	long 	DrawX(HDC hdc, long x, long y, long cx, long cy, RECT* pClipRect=NULL, bool bSmooth = false, 
	...
	CxImage	*DrawString2(HDC hdc, long x, long y, CXTEXTINFO *pTextType, bool bSetAlpha=false );
